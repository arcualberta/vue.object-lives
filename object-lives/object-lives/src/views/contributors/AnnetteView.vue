<template>
    <div class="container">
        <div class="image-container">
            <img src="@/assets/Contributor-11.gif" alt="Annette de Stecher" class="img-fluid">
        </div>
